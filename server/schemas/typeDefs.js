...
const typeDefs = gql`
    ...
    type Mutation {
        ...
        addConcert(customId: String, artists: String, venue: String, date: String, times: String, address: String, address2: String, phone: String, website: String, email: String, ticketLink: String, artistsLink: String): String
